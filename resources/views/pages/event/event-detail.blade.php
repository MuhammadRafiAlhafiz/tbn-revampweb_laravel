...
<html data-theme="light" lang="id">
  ...
  <body class="font-popins">
    ...
    <!-- THE SPEAKER -->
    <img class="flex justify-center w-full mt-20" src="/assets/event-detailspeaker1.svg" alt="">
    <!-- END THE SPEAKER -->
    ...
    <section class="mt-20 bg-background py-16 mx-52 rounded-3xl">
        <div class="flex justify-center gap-14">
          ...
          <span class="mt-52 justify-center items-center text-center">
            @guest
            <a class="border-transparent py-3 px-10 rounded-xl bg-hijau text-white" href="{{ route('login') }}"><button>Choose plan</button></a>
        @else
            <!-- Mengarahkan pengguna ke halaman choose-plan jika sudah login -->
            <a class="border-transparent py-3 px-10 rounded-xl bg-hijau text-white" href="{{ route('register', ['id' => $program->id]) }}"><button>Choose plan</button></a>
        @endguest
          </span>
          </div>
