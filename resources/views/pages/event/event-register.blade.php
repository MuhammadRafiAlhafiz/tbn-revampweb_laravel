...
<html data-theme="light" lang="id">
  ...
  <body class="font-popins">
    ...
    <section id="Payment-section">
      <div class="flex flex-col justify-center items-center mt-10">
        ...
        <span class="w-[1000px] mt-10">
          <a href="event.html"><p class="text-hijau py-5 font-nunito text-[20px] font-normal">
            [ About Conference ]
          </p></a>
    ...
    <!-- SHARING experiences -->
    <section>
      <h1 class="mt-24 mx-28 text-[34px] font-semibold font-popins">
    ...
    <section id="" class="flex justify-center mt-20">
      <div class="bg-white p-8 rounded-lg w-full max-w-md">
        <div class="flex flex-col items-center">
          ...
          <h1
            class="font-popins text-[56px] font-bold text-blue-950 mb-2 w-[610px] h-[67px]"
          >
            Share Your Feedback
          </h1>
          <p class="font-popins text-[21px] font-semibold mb-6">
    ...
    <footer class="bg-white mt-10">
      <div class="flex flex-col md:flex-row md:p-10 justify-between">
        ...
        <div>
          <h1 class="font-popins font-semibold text-[21px] md:text-lg mt-2">
            Perusahaan
          </h1>
          <div
        ...
        <div>
          ...
          <div class="flex gap-1 mt-2">
            <img
              ...
              alt="Email"
            />
            <a href="mailto:hello@tbnalliance.org">hello@tbnalliance.org</a>
          </div>
        </div>
      </div>
      <div class="bg-biru">
        <p class="text-center p-5 text-white text-[16px] font-bold">
