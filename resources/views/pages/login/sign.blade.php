...
<head>
  ...
  <body class="font-popins">
    ...
    <!-- LOGIN -->
    <section
      class="py-24 px-4 md:py-[65px] flex flex-col md:flex-row justify-center items-center md:mr10 gap-20"
    >
      <!-- Carousel -->
            ...
            <div class="flex">
                <label
                    ...
                    <div class="mb-4 flex gap-3">
                        <input id="name" type="text" class="form-control mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full md:w-[220px] p-2 shadow-sm sm:text-sm border-gray-600 border-2 rounded-md @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                    ...
                    <div class="mb-4 flex gap-4">
                        <input id="email" type="email" class="form-control mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full md:w-[220px] p-2 shadow-sm sm:text-sm border-gray-600 border-2 rounded-md @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
